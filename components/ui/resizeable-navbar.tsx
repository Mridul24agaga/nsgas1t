...
export const NavbarLogo = ({ visible }: { visible?: boolean }) => {  return (
    <a href="#" className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1">
      {/* Add your custom logo image here */}
      <div className="h-8 w-auto">
        <img 
        src="/yuktara.png" 
        alt="Your Logo" 
        className={`transition-all duration-300 ${visible ? "h-6 w-auto" : "h-8 w-auto"}`} 
      />
        </div>
    </a>
  )
